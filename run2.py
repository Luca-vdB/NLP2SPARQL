...
def main():
    ...
    parser.add_argument('--user_input', type=int, default=0,
                        help="allow user input queries")
    parser.add_argument('--user_query', type=str, default=None,
                        help="read user input queries")
    ...
    if args.do_test:
        files = []
        if(args.user_input):
            file_name = 'example.en'
            with open(file_name, 'w', encoding='utf-8') as my_file:
                my_file.write(args.user_query)
